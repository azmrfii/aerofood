...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'text' => 'Purchase Order',
            'url' => 'menu/purchase_order',
            'icon' => 'far fa-fw fa-file-invoice',
        ],
        [
            'text' => 'Barang',
            'url' => 'menu/barang',
        ...
        [
            'text' => 'Bongkar Muat',
            'url' => 'menu/bongkar_muat',
            'icon' => 'far fa-fw fa-truck-loading',
        ],
        [
            'text' => 'Persentase Keuntungan',
            'url' => 'menu/persentase_keuntungan',
            'icon' => 'far fa-fw fa-chart-line',
        ],
        [
            'text' => 'Estimasi Hari Pembayaran',
            'url' => 'menu/estimasi_hari_pembayaran',
